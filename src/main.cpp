...
int main()
{
    ...
    // -------------------------
    Shader ourShader(FileSystem::getPath("/shaders/shader.vert").c_str(), FileSystem::getPath("/shaders/shader.frag").c_str());

    // load models
    // -----------
    Model ourModel(FileSystem::getPath("assets/models/nanosuit/nanosuit.obj"));
